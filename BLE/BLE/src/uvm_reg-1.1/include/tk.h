 ...
 *
 * RCS: @(#) $Id: tk.h,v 1.74.2.16 2006/05/04 13:09:46 dgp Exp $
 */
...
#define Tk_IsFrame(tkwin) \
	(((Tk_FakeWin *) (tkwin))->flags & TK_FRAME)
 ...
 * TK_FRAME:		1 means this is a Frame (or derived from Frame)
 ...
 *				up to this window.
 * TK_URBAN_RENEWAL	1 means this window needs to be re-created
 *				from the ground up because it's been reparented.
 */
...
#define TK_FRAME		0x80000
#define TK_URBAN_RENEWAL	0x100000

/*
 *--------------------------------------------------------------
 *
