...
/* $Id: //dvt/mti/rel/10.0b/src/vsim/acc_user.h#1 $ */
...
XXTERN handle     *acc_collect PROTO_PARAMS((handle (*p_next_routine)(void), handle scope_object, PLI_INT32 *aof_count));
...
XXTERN PLI_INT32   acc_count PROTO_PARAMS((handle (*next_func)(void), handle object_handle));
