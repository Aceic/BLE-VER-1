...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/systemc/sc_bigint.h#1 $
...
public:
    ...
    sc_bigint(mtiLongT v )
	: sc_signed( W )
	{ *this = v; }

    sc_bigint(mtiUlongT v )
	: sc_signed( W )
	{ *this = v; }
    ...
    sc_bigint<W>& operator = (mtiLongT v )
	{ sc_signed::operator = ( v ); return *this; }

    sc_bigint<W>& operator = (mtiUlongT v )
	{ sc_signed::operator = ( v ); return *this; }
