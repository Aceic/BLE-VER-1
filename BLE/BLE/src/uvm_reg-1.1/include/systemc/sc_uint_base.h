...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/systemc/sc_uint_base.h#1 $
...
public:
    ...
    sc_uint_subref& operator = (mtiUlongT a )
	{ return operator = ( (uint_type) a ); }

    sc_uint_subref& operator = (mtiLongT a )
	{ return operator = ( (uint_type) a ); }
...
public:
	...
	: m_val( a->to_uint64() ), m_len( a->length() ), 
	  m_ulen( SC_INTWIDTH - m_len ), m_mti_value( NULL )
	{ check_length(); extend_sign(); }
    ...
    sc_uint_base& operator = (mtiUlongT a )
	{ m_val = a; extend_sign(); return *this; }

    sc_uint_base& operator = (mtiLongT a )
	{ m_val = a; extend_sign(); return *this; }
