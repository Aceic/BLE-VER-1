...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/systemc/sc_nbutils.h#1 $
...
// u = v
// - v is an mtiUlongT or uint64, and positive integer.
template< class Type >
inline
void
...
// u can be mtiLongT, mtiUlongT, int64, or uint64.
template< class Type >
inline
small_type
get_sign(Type &u) 
...
#if !(defined(WIN32) || defined(i386) || defined(__x86_64__) || defined(__EDG__) || (defined(__hpux) && !defined(__HP_aCC)))
#if defined( __HP_aCC ) && defined( isfinite )
