...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/systemc/sc_biguint.h#1 $
...
public:
    ...
    sc_biguint(mtiLongT v )
	: sc_unsigned( W )
	{ *this = v; }

    sc_biguint(mtiUlongT v )
	: sc_unsigned( W )
	{ *this = v; }
    ...
    sc_biguint<W>& operator = (mtiLongT v )
	{ sc_unsigned::operator = ( v ); return *this; }

    sc_biguint<W>& operator = (mtiUlongT v )
	{ sc_unsigned::operator = ( v ); return *this; }
