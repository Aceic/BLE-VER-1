...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/systemc/sc_port.h#1 $
...
private:
	...
	// This port belongs to a foreign module (hdl)
	bool             m_mti_is_foreign;
	bool			 m_mti_is_boundary_top;
	mtiObjectHandleT m_mti_channel_id; // prim channel this port is connected to
	mtiObjectHandleT m_mti_region_id;  // module region id
	mtiObjectHandleT m_mti_port_id;
	mtiDirectionT    m_mti_port_dir;

protected:

	void mti_set_is_foreign()
		{ m_mti_is_foreign = true; }

	void mti_set_is_boundary_top()
		{ m_mti_is_boundary_top = true; }

	void mti_set_region_id( mtiObjectHandleT mti_region_id )
		{ m_mti_region_id = mti_region_id; }

	void mti_set_port_dir(mtiDirectionT mti_port_dir)
		{ m_mti_port_dir = mti_port_dir; }

	void mti_create_signal_alias();
...
public:
	...
	mtiObjectHandleT mti_get_channel_id()
		{ return m_mti_channel_id; }

	mtiObjectHandleT mti_get_port_id()
		{ return m_mti_port_id; }

	void mti_set_channel_id( mtiObjectHandleT mti_channel_id )
		{ m_mti_channel_id = mti_channel_id; }

	bool mti_is_foreign()
		{ return m_mti_is_foreign; }
...
private:
	...
	void mti_complete_binding(sc_interface* iface);
