...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/systemc/sc_bit_proxies.h#1 $
...
public:
    ...
    sc_subref<X>& operator = (mtiUlongT a )
	{ base_type::assign_( a ); return *this; }

    sc_subref<X>& operator = (mtiLongT a )
	{ base_type::assign_( a ); return *this; }
...
public:
    ...
    sc_concref<X,Y>& operator = (mtiUlongT a )
	{ base_type::assign_( a ); return *this; }

    sc_concref<X,Y>& operator = (mtiLongT a )
	{ base_type::assign_( a ); return *this; }
