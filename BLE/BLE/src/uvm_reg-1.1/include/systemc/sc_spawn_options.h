...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/systemc/sc_spawn_options.h#1 $

 *****************************************************************************/

// $Log: sc_spawn_options.h,v $
// Revision 1.2  2007/02/27 03:20:56  huiyin
// add SystemC DPI debug support
//
...
class sc_spawn_options {
  ...
  protected:
    ...
    // BEGIN MODELSIM MODIFICATIONS
    ptrarray<const sc_event*>     m_sensitive_events;
    ptrarray<sc_event_finder*>    m_sensitive_event_finders; 
    ptrarray<sc_interface*>       m_sensitive_interfaces;
    ptrarray<sc_port_base*>       m_sensitive_port_bases;
    // END MODELSIM MODIFICATIONS
