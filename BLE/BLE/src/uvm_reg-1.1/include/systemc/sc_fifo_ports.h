...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/systemc/sc_fifo_ports.h#1 $
...
template <class T>
class sc_fifo_in
: public sc_port<sc_fifo_in_if<T>,0,SC_ZERO_OR_MORE_BOUND>
{
public:
    ...
    typedef sc_port<if_type,0,SC_ZERO_OR_MORE_BOUND> base_type;
...
template <class T>
class sc_fifo_out
: public sc_port<sc_fifo_out_if<T>,0,SC_ZERO_OR_MORE_BOUND>
{
public:
