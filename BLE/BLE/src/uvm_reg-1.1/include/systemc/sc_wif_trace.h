...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/systemc/sc_wif_trace.h#1 $
...
protected:
    ...
    // Trace an mtiUlongT with the given width
     void trace(const mtiUlongT& object, const std::string& name, 
         int width);
    ...
    // Trace a signed mtiLongT with the given width
     void trace(const mtiLongT& object, const std::string& name, int width);
