...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/systemc/sc_fxval.h#1 $
...
public:
    ...
    explicit sc_fxval_fast( sc_fxval_fast_observer* = 0 );
             ...
             sc_fxval_fast( unsigned int,
			    sc_fxval_fast_observer* = 0 );
             sc_fxval_fast( mtiLongT,
			    sc_fxval_fast_observer* = 0 );
             sc_fxval_fast( mtiUlongT,
			    sc_fxval_fast_observer* = 0 );
...
{
    SC_FXVAL_OBSERVER_READ_( *this )
    return static_cast<mtiLongT>( m_rep->to_double() );
}
...
{
    SC_FXVAL_OBSERVER_READ_( *this )
    return static_cast<mtiUlongT>( m_rep->to_double() );
}
...
{
    SC_FXVAL_FAST_OBSERVER_READ_( *this )
    return static_cast<mtiLongT>( m_val );
}
...
{
    SC_FXVAL_FAST_OBSERVER_READ_( *this )
    return static_cast<mtiUlongT>( m_val );
}
