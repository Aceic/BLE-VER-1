...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/systemc/sc_bv_base.h#1 $
...
public:
	...
	: m_len( 0 ), m_size( 0 ), m_data( 0 ), m_mti_value( 0 )
	{ init( length_ ); }
	...
	{ 
		...
		if ( m_mti_value != NULL ) delete [] m_mti_value; 
    ...
    sc_bv_base& operator = (mtiUlongT a )
	{ base_type::assign_( a ); return *this; }

    sc_bv_base& operator = (mtiLongT a )
	{ base_type::assign_( a ); return *this; }
