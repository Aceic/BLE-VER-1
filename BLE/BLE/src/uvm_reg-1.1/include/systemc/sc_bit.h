...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/systemc/sc_bit.h#1 $
...
public:
    ...
    sc_bit()
	: m_val( false ), m_mti_value(0)
	{
		sc_deprecated_sc_bit();
	}

    explicit sc_bit( uint64 a )
	: m_val( a ), m_mti_value(0)
	{
		sc_deprecated_sc_bit();
	}
	...
	: m_val( to_value( a ) ), m_mti_value(0)
	{
		sc_deprecated_sc_bit();
	}
    ...
    sc_bit& operator = (mtiLongT b )
	{ return ( *this = sc_bit( (int)b ) ); }

    sc_bit& operator = (mtiUlongT b )
	{ return ( *this = sc_bit( (int)b ) ); }
...
private:
	...
	unsigned char m_mti_value; /* Interpreted MTI value */
