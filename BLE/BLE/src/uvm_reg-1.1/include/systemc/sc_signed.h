...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/systemc/sc_signed.h#1 $
...
// friend operator declarations
  ...
  sc_signed operator + (const sc_signed&    u, mtiLongT                v);
  sc_signed operator + (const sc_signed&    u, mtiUlongT       v);
  ...
  sc_signed operator + (mtiLongT u, const sc_signed&    v);
  sc_signed operator + (mtiUlongT u, const sc_signed&    v);
  ...
  bool operator == (const sc_signed&    u, mtiLongT                v);
  bool operator == (const sc_signed&    u, mtiUlongT       v);
  ...
  bool operator == (mtiLongT u, const sc_signed&    v);
  bool operator == (mtiUlongT u, const sc_signed&    v);
...
public:
    ...
    const sc_signed_subref& operator = (mtiUlongT a );
    const sc_signed_subref& operator = (mtiLongT a );
...
public:
    ...
    const sc_signed& operator = (mtiLongT v);
    const sc_signed& operator = (mtiUlongT v);
  ...
  friend sc_signed operator + (const sc_signed&    u, mtiLongT                v); 
  friend sc_signed operator + (const sc_signed&    u, mtiUlongT       v);
  ...
  friend sc_signed operator + (mtiLongT u, const sc_signed&    v); 
  friend sc_signed operator + (mtiUlongT u, const sc_signed&    v);
  ...
  friend bool operator == (const sc_signed&    u, mtiLongT                v); 
  friend bool operator == (const sc_signed&    u, mtiUlongT       v);
  ...
  friend bool operator == (mtiLongT u, const sc_signed&    v); 
  friend bool operator == (mtiUlongT u, const sc_signed&    v);
...
private:
  unsigned char* m_mti_value; // Interpreted value
...
//
template< class T >
inline const sc_signed_subref& sc_signed_subref::operator = ( const sc_generic_base<T>& a )
{   
