...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/systemc/sc_report.h#1 $
...
public:
    virtual const char *kind() const { return "sc_report"; }
	...
	void print(std::ostream& os, int details, int indent) const;
...
extern const char SC_ID_OUT_OF_BOUNDS_WARN_[];
// END MODELSIM ADDITIONS
