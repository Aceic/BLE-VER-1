...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/systemc/sc_trace.h#1 $
...
// specializations for signals of type char, short, int, mtiLongT
...
void sc_trace( sc_trace_file* tf,
	       const sc_signal_in_if<mtiLongT>& object,
	       const std::string& name,
	       int width );
...
extern const int UL_SIZE;

extern const mtiUlongT UL_ZERO;
extern const mtiUlongT UL_ONE;
