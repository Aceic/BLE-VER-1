// $Id: //dvt/mti/rel/10.0b/src/systemc/placeholders.hpp#1 $
...
boost::arg<3> _3 __attribute__ ((unused));
boost::arg<4> _4 __attribute__ ((unused));
boost::arg<5> _5 __attribute__ ((unused));
boost::arg<6> _6 __attribute__ ((unused));
boost::arg<7> _7 __attribute__ ((unused));
boost::arg<8> _8 __attribute__ ((unused));
boost::arg<9> _9 __attribute__ ((unused));
