...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/scv/scv/_scv_ext_rw.h#1 $
...
// BEGIN MODELSIM MODIFICATIONS [MDE-SCV]
  const T& read() const { return *get_instance(); }
...
// ----------------------------------------
template<typename T>
class scv_extension_rw< vector<T> >
  : public _SCV_INTROSPECTION_BASE3 {
  typedef vector<T> my_type;
public:
// BEGIN MODELSIM MODIFICATIONS [MDE-SCV]
  scv_extension_rw():_instance(NULL) {}
// END MODELSIM MODIFICATIONS [MDE-SCV]
  virtual ~scv_extension_rw() {}
...
public:
  ...
  virtual void resize_vector(unsigned old_size, unsigned new_size) {
    // First propagate the effects of resize to the various lower layers of the
    // vector<T> extension.
    scv_extension_type< vector<T> >::resize_vector(old_size, new_size);

    // Now perform effects of resize to this layer
    if (_get_instance()) {
      _get_instance()->resize(new_size);
      _set_instance_core_wrap(_get_instance());
    }
  }
};

template<typename T> void scv_extension_rw< vector<T> >::assign(bool) {
  _SCV_RW_ERROR(assign,bool,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::assign(char) {
  _SCV_RW_ERROR(assign,char,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::assign(unsigned char) {
  _SCV_RW_ERROR(assign,unsigned char,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::assign(short) {
  _SCV_RW_ERROR(assign,short,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::assign(unsigned short) {
  _SCV_RW_ERROR(assign,unsigned short,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::assign(int) {
  _SCV_RW_ERROR(assign,int,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::assign(unsigned) {
  _SCV_RW_ERROR(assign,unsigned,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::assign(long) {
  _SCV_RW_ERROR(assign,long,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::assign(unsigned long) {
  _SCV_RW_ERROR(assign,unsigned long,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::assign(long long) {
  _SCV_RW_ERROR(assign,long long,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::assign(unsigned long long) {
  _SCV_RW_ERROR(assign,unsigned long long,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::assign(float) {
  _SCV_RW_ERROR(assign,float,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::assign(double) {
  _SCV_RW_ERROR(assign,double,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::assign(const string&) {
  _SCV_RW_ERROR(assign,string,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::assign(const char *) {
  _SCV_RW_ERROR(assign,const char *,vector);
}

template<typename T> bool scv_extension_rw< vector<T> >::get_bool() const  {
  _SCV_RW_ERROR(get_bool,bool,vector); return false;
}
template<typename T> long long scv_extension_rw< vector<T> >::get_integer() const  {
  _SCV_RW_ERROR(get_integer,integer,vector); return 0;
}
template<typename T> unsigned long long scv_extension_rw< vector<T> >::get_unsigned() const {
  _SCV_RW_ERROR(get_unsigned,unsigned,vector); return 0;
}
template<typename T> double scv_extension_rw< vector<T> >::get_double() const {
  _SCV_RW_ERROR(get_double,double,vector); return 0;
}
template<typename T> std::string scv_extension_rw< vector<T> >::get_string() const {
  _SCV_RW_ERROR(get_string,string,vector); return std::string("");
}

#ifdef SYSTEMC_H
template<typename T> void scv_extension_rw< vector<T> >::assign(const sc_bv_base& v) {
  _SCV_RW_ERROR(assign,sc_bv_base,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::get_value(sc_bv_base& v) const {
  _SCV_RW_ERROR(get_value,sc_bv_base,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::assign(const sc_lv_base& v) {
  _SCV_RW_ERROR(assign,sc_lv_base,vector);
}
template<typename T> void scv_extension_rw< vector<T> >::get_value(sc_lv_base& v) const {
  _SCV_RW_ERROR(get_value,sc_lv_base,vector);
}
#endif
...
#define _SCV_INTROSPECTION_BASE3 scv_extension_rw< vector<T> >
// END MODELSIM ADDITIONS [MDE-SCV]
