...
/*****************************************************************************
  ...
  $Id: //dvt/mti/rel/10.0b/src/scv/scv/_scv_randomization.h#1 $
  ...
  scv_bag<T>* dist)
{
  ...
  case scv_extensions_if::SC_SIGNED : 
  ...
  case scv_extensions_if::SC_UNSIGNED :
  case scv_extensions_if::BIT :
  case scv_extensions_if::BIT_VECTOR :
  case scv_extensions_if::LOGIC :
...
_SCV_KEEP_RANGE_LIST_INT_TYPE(mtiLongT)
...
_SCV_KEEP_RANGE_LIST_UNSIGNED_TYPE(mtiUlongT)
